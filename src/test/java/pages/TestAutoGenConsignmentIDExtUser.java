...
public class TestAutoGenConsignmentIDExtUser extends TestBase {
    ...
    public void clickOnAccordianAndSelectExternalUserCompany() throws InterruptedException {
        ...
        pageDashBoard.selectCompanyAssignedSingleBilledTo();
    ...
    @Test(dataProviderClass = DataProviderList.class, dataProvider = "AutoGenOutboundConsignmentID")
//    @Test()
    public void externalUserAutoGenConsignmentIDOutbound(Map<String, String> testDataSet) throws InterruptedException {
...
//    if(pageConsignment.verifyRICA()){
    ...
    @Test(dataProviderClass = DataProviderList.class, dataProvider = "AutoGenInboundConsignmentID")
//    @Test()
    public void externalUserAutoGenConsignmentInbound(Map<String, String> testDataSet) throws InterruptedException {
        pageConsignment = new PageConsinment(eventFiringWebDriver);
        Thread.sleep(15000);
